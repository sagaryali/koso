...
export function getHomeTour(hasEvidence: boolean): TourStep[] {
  ...
  if (hasEvidence) {
    ...
    steps.push({
      target: '[data-tour="home-evidence-hero"]',
      title: "Start by adding evidence",
      description:
        "Paste customer feedback, metrics, or notes here. After 3 items, Koso will analyze themes.",
      position: "bottom",
    });
  }
